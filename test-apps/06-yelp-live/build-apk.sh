...
APK_NAME="westlake-yelp-live-debug.apk"
UNSIGNED_APK="$DIST_DIR/westlake-yelp-live-unsigned.apk"
ALIGNED_APK="$DIST_DIR/westlake-yelp-live-aligned.apk"
...
echo "=== Building Westlake Yelp live APK ==="
