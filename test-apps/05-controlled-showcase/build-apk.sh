...
APK_NAME="westlake-showcase-debug.apk"
UNSIGNED_APK="$DIST_DIR/westlake-showcase-unsigned.apk"
ALIGNED_APK="$DIST_DIR/westlake-showcase-aligned.apk"
...
echo "=== Building Westlake controlled showcase APK ==="
